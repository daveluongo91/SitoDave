(() => {
  ...
  document.querySelectorAll('.open-info-modal').forEach((button) => {
    button.addEventListener('click', () => {
      infoModal.dataset.subject = button.dataset.subject || '[DARDAGNA 2026] Richiesta informazioni';
    ...
    try {
      const response = await fetch(`${API_BASE}/send-info-email`, {
        ...
        body: JSON.stringify({
          ...
          source: WORKSHOP_ID,
          subject: infoModal.dataset.subject || '[DARDAGNA 2026] Richiesta informazioni',
