# Workshop Canfaito & Conero 2026 — Faggeta e Costa Adriatica

Cartella autonoma destinata a `/Canfaito_Conero_2026/`.
...
- Le richieste informazioni arrivano con il marker `[CANFAITO & CONERO 2026]`.
...
- Disponibilità: `/api/workshops/canfaito-2026/seats`.
...
La cartella produttiva locale è `L:\Canfaito_Conero_Prod`. Lo specchio versionato è
`Sito_Dave/standalone_pages/Canfaito_Conero_Prod`. Le due copie devono restare identiche.
